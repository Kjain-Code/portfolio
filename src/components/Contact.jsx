...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    // Replace with your form submission logic (EmailJS, etc.)
    setSent(true)
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:kritikajain@email.com" className="text-slate-300 hover:text-teal-400 transition-colors">
                    kritika098jain@email.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <span className="text-slate-300">India · Remote Available</span>
                </div>
              </div>
              ...
              <div className="flex gap-3 pt-2">
                {[
                  ...
                  <a key={label} href={href} target="_blank" rel="noopener noreferrer"
                    className="p-3 rounded-xl border border-white/10 text-slate-400 hover:text-teal-400 hover:border-teal-400/30 transition-all">
                    <Icon size={18} />
                  </a>
                ))}
              </div>
